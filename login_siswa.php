		...
		<div class="card">
			<div class="card-body login-card-body" style="border-radius: 15px; box-shadow: 4px 4px 10px rgba(0, 0, 0, 0.2);">
				...
				<form action="" method="post">
					...
					<div class="input-group mb-3">
						<input type="password" class="form-control" name="nis" placeholder="Password" required>
						<div class="input-group-append">
							<div class="input-group-text">
					...
					<div class="row">
						<div class="col-12">
							...
							<center>
    <a class="btn mt-2 text-decoration-none text-dark" href="login.php" 
...
<?php if (isset($_POST['btnLogin'])) {
    ...
    //query login
    $sql_login = "SELECT * FROM siswa WHERE BINARY nama_siswa='$nama' AND nis='$nis'";
    ...
    if ($jumlah_login == 1) {
        session_start();
        $_SESSION['ses_nis'] = $data_login['nis'];
        $_SESSION['ses_siswa'] = $data_login['nama_siswa'];
